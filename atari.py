...
class Atari:
    ...
    def _args(self):
        ...
        print("Selected game: " + str(self.game_name))
        print("Selected mode: " + str(self.game_mode))
        print("Should render: " + str(self.render))
        print("Should clip: " + str(self.clip))
        print("Total step limit: " + str(self.total_step_limit))
        print("Total run limit: " + str(self.total_run_limit))
    ...
    def _save_scores(self, l_scores, directory_path = "./scores/"):
        ...
        directory_path = directory_path + self.game_name + "/"
